...
- **On target:** Dazed (magnitude 1, 4 rounds, 15% chance)
...
- [mywildcave](../maps/mywildcave.md)
- [mywildcave1](../maps/mywildcave1.md)
- [mywildcave2](../maps/mywildcave2.md)
- [mywildcave3](../maps/mywildcave3.md)

<small>Monster ID: `old_stone_worm` · Data from v0.8.18</small>
