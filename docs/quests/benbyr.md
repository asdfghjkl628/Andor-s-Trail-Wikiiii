...
| 30 | Benbyr was thrilled to hear that all of Tinlyn's sheep are dead. **(completes quest)** |
| 60 | I declined to help Benbyr kill the sheep. **(completes quest)** |

<small>Quest ID: `benbyr` · Data from v0.8.18</small>
