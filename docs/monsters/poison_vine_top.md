...
- **On target:** Weak Poison (magnitude 3, 5 rounds, 90% chance); Blistering skin (magnitude 3, 4 rounds, 80% chance)

## Found on

- [island_underground2](../maps/island_underground2.md)
- [island_underground3](../maps/island_underground3.md)
- [laerothcave0](../maps/laerothcave0.md)
- [secretpassage1](../maps/secretpassage1.md)

<small>Monster ID: `poison_vine_top` · Data from v0.8.18</small>
