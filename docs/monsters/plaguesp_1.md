...
- **On target:** Insect contagion (magnitude 1, 5 rounds, 70% chance); Blistering skin (magnitude 1, 5 rounds, 20% chance)
...
- [waytolake7b](../maps/waytolake7b.md)
- [waytolake9](../maps/waytolake9.md)

<small>Monster ID: `plaguesp_1` · Data from v0.8.18</small>
